...
export default class App extends React.Component {
    ...
    return (
      <View
        ...
        <TextInput
               ...
               autoCapitalize = "none"
               onChangeText = {this.descriptionHand}/>
        <Button
  ...
  _saveValue = async () => {
    try {
      ...
      await firebase.database().ref('example/' + this.state.image).set({ imageURL: this.state.image , description : this.state.description });
    } catch(e) {
      // Error! oh no
    } finally {
